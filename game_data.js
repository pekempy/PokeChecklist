...
export const gen3Wild = {
  ...
  firered: {
    ...
    116: { loc: "Route 19 (Fishing)", sec: 7 },
    117: { loc: "Route 19 (Fishing)", sec: 7 },
    90: { loc: "Vermilion City (Fishing)", sec: 3 },
    98: { loc: "Vermilion City (Fishing)", sec: 3 },
    99: { loc: "Vermilion City (Fishing)", sec: 3 },
    118: { loc: "Route 6 (Fishing)", sec: 3 },
    119: { loc: "Route 6 (Fishing)", sec: 3 },
    60: { loc: "Route 6 (Fishing)", sec: 3 },
    61: { loc: "Route 6 (Fishing)", sec: 3 },
  ...
  leafgreen: {
    ...
    116: { loc: "Route 19 (Fishing)", sec: 7 },
    117: { loc: "Route 19 (Fishing)", sec: 7 },
    120: { loc: "Vermilion City (Fishing)", sec: 3 },
    98: { loc: "Vermilion City (Fishing)", sec: 3 },
    99: { loc: "Vermilion City (Fishing)", sec: 3 },
    118: { loc: "Route 6 (Fishing)", sec: 3 },
    119: { loc: "Route 6 (Fishing)", sec: 3 },
    ...
    223: { loc: "Trainer Tower (Fishing)", sec: 10 },
    224: { loc: "Trainer Tower (Fishing)", sec: 10 },
